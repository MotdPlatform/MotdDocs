...
[前端接口](https://github.com/MotdPlatform/ClientAPI_Doc/blob/main/Front_API.md)

[客户端接口](https://github.com/MotdPlatform/ClientAPI_Doc/blob/main/Client_API.md)

[相关客户端需求](https://github.com/MotdPlatform/ClientAPI_Doc/blob/main/Client_Requirements.md)

[HTTP状态](https://github.com/MotdPlatform/ClientAPI_Doc/blob/main/HTTPStatus.md)
...
参数 | 类型 | 备注
 --- | --- | --- 
status | Number | 将严格按照[HTTP状态](https://github.com/MotdPlatform/ClientAPI_Doc/blob/main/HTTPStatus.md)规则
msg | String | 附加信息
client| Object | 客户端信息
